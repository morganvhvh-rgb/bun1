    ...
    return (
        ...
        >
            <div className="flex justify-end items-center mb-2 shrink-0">
                <button onClick={onClose} className="text-zinc-400 hover:text-[#f0e8d8] transition-colors">
            ...
            <div className="flex-1 min-h-0 flex flex-col">
                <div className="flex-1 w-full">
                    <div className="flex flex-col gap-4 text-sm text-zinc-300">
                        <p><strong className="text-[#f0e8d8] text-base font-semibold">DAILY ROGUE</strong> has two main sections:</p>

                        <div className="bg-white/5 border border-white/10 p-4 rounded-xl flex flex-col gap-1.5 shadow-sm">
                            <p className="font-bold text-[#f0e8d8] mb-1 uppercase tracking-widest text-[11px] opacity-70">Top Half</p>
                        ...
                        <div className="bg-white/5 border border-white/10 p-4 rounded-xl flex flex-col gap-1.5 shadow-sm">
                            <p className="font-bold text-[#f0e8d8] mb-1 uppercase tracking-widest text-[11px] opacity-70">Bottom Half</p>
