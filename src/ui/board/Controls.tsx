    ...
    return (
        <div className="relative flex flex-col" style={{ gap: 'var(--gap)', marginLeft: '2px' }}>
            ...
            <button
                ...
                className="absolute left-1/2 -translate-x-1/2 rounded-full grid place-items-center focus:outline-none active:scale-95 transition-transform bg-blue-600 border border-blue-700"
                style={{
