...
export function HeroPanel({ playerAnim, isBattleRunning, onCharacterClick }: HeroPanelProps) {
    ...
    return (
        <div className="flex-1 flex flex-col relative overflow-visible w-full max-w-[50%] h-full py-2 px-1.5 sm:py-3 sm:px-2 items-center justify-between z-20">
            {/* Avatar Section */}
            ...
            {/* Unified Stats Grid */}
            <div className="flex flex-col gap-1.5 w-full shrink-0 mt-auto pb-1 pt-2 sm:pt-3">
                {/* Row 1: HP & LVL */}
