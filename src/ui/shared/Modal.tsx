                ...
                <>
                    ...
                    >
                        <motion.div
                            ...
                            className={cn(
                                'bg-black border border-zinc-900 flex flex-col p-5 pointer-events-auto',
                                positionClasses[pos],
                                className
                            )}
                        ...
                        >
                            ...
                            {showHeader && (
                                <div className="flex justify-between items-center mb-4">
                                    <h2 className="text-[#e8d4b8] font-bold uppercase tracking-widest leading-none text-sm">{title}</h2>
